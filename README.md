...
for example POST and PUT HTTP requests. I had some problems with all of those not working correctly but I got them working through testing. 
...
could be a bit better. Everything else is working.
